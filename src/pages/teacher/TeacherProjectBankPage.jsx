...
export default function TeacherProjectBankPage() {
  ...
  // Teacher quiz difficulty setting (shared via localStorage)
        ...
        <section className="teacher-class-page teacher-class-page--shell">
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 16, flexWrap: "wrap", alignItems: "center" }}>
            <select
              ...
              style={{ padding: "8px 10px", borderRadius: 8, border: "1px solid var(--border)", background: "var(--bg2)", color: "var(--text)", fontSize: 13 }}
            >
            ...
            <input
              ...
              style={{ flex: 1, minWidth: 180, padding: "8px 10px", borderRadius: 8, border: "1px solid var(--border)", background: "var(--bg2)", color: "var(--text)", fontSize: 13 }}
            />
          </div>

          {/* 🎓 Quiz Difficulty Setting Panel */}
          <div style={{
            ...
            <span style={{ fontSize: 12, color: "var(--text3)", flex: 1 }}>
              Controls how many questions students see in quizzes
            </span>
            {[
              { id: "all",          label: "All Questions", icon: "📚", color: "#64748b" },
              ...
              return (
                <button key={d.id} type="button" onClick={() => saveQuizDifficulty(d.id)}
                  style={{
                    padding: "5px 12px", borderRadius: 8, cursor: "pointer",
                    border: `1px solid ${active ? d.color : "var(--border)"}`,
                    background: active ? `${d.color}22` : "var(--bg2)",
