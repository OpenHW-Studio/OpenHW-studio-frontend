...
const load = async () => {
      ...
      if (bankMode) {
        if (isNewBankProject) {
          ...
          if (!cancelled) {
            ...
            setAssessmentNodeContent(
              buildSimulatorImportedAssessment(createDefaultAssessment()) || createDefaultAssessment()
            );
            setLoading(false);
          }
          return;
        ...
        try {
          ...
          setAssessmentNodeContent(buildSimulatorImportedAssessment(baseAssessment) || baseAssessment);
