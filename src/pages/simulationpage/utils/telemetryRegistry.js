...
export const COMPONENT_TELEMETRY_PARAMS = {
  ...
  'openhw-ir-receiver': ['powered', 'transmitting', 'lastButton', 'lastValue', 'lastProtocol', 'lastAddress', 'lastCommand', 'signalStrength'],
  'openhw-ir-transmitter': ['active', 'protocol', 'address', 'command', 'lastSignal', 'receiversInRange'],
  ...
  'wokwi-ir-receiver': ['powered', 'transmitting', 'lastButton', 'lastValue', 'lastProtocol', 'lastAddress', 'lastCommand', 'signalStrength'],
  'wokwi-ir-transmitter': ['active', 'protocol', 'address', 'command', 'lastSignal', 'receiversInRange'],
